...
<body>
    ...
    <section id="welcome">
        <div>
            <h1>Welcome to the Boys Hostel</h1>
            <p>We provide safe, comfortable, and affordable accommodation for boys at our hostel.</p>
            <img src="3h.jpg" alt="hostel">
        </div>
    </section>
    ...
    <section id="info">
        ...
        <p>Our Boys Hostel has a variety of rooms available for students. Below are the details:</p>
        <div class="room-info">
            <div>
            ...
            <div>
                <img src="4h.jpg" alt="Room Image">
                <h3>Total Students</h3>
                <p>400 Students</p>
            </div>
            <div>
                <img src="8bed.jpg" alt="Room Image">
